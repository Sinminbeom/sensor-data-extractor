...
int main(int argc, char *argv[])
{
  ...
  param.input_param.correction_file_path = "/App/Cpp/correction/angle_correction/AT128E2X_Angle Correction File.dat";
  param.input_param.firetimes_path = "/App/Cpp/correction/firetime_correction/AT128E2X_Firetime Correction File.csv";
